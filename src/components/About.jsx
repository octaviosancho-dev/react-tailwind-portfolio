      ...
      <div id='about' className='flex-wrap w-3/4 mt-96 sm:mx-auto sm:mt-[500px] sm:w-4/6 mx-auto lg:flex-nowrap flex flex-row justify-between gap-10 lg:w-3/4'>
        <div className='w-full lg:w-4/5 text-gray-300'>
          ...
          <div className='ml-0 sm:ml-10 md:ml-20'>
            ...
            <p className='mb-5 text-xs md:text-sm lg:text-lg'><FormattedMessage id='about-second-paragraph' defaultMessage='I have 1 year of experience creating Websites and developing Software Applications, I always keep myself learning new Skills. I usually work with ReactJS, JavaScript, Tailwind.css, Sass, and other technologies.",
  "about-third-paragraph": "I truly believe that my strong points lies in development and research , but also I really love designing the applications I create. Currently, I am looking for my first IT experience in a company and focusing on dominate Back-End Technologies. I want to scale up my skills and grow as professional.'/></p>
